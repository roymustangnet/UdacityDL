...
def conv2d_maxpool(x_tensor, conv_num_outputs, conv_ksize, conv_strides, pool_ksize, pool_strides):
    ...
    :param x_tensor: TensorFlow Tensor 输入数据
    :param conv_num_outputs: Number of outputs for the convolutional layer 卷积输出层的维度
    :param conv_ksize: kernal size 2-D Tuple for the convolutional layer 卷积核的大小
    :param conv_strides: Stride 2-D Tuple for convolution 
    :param pool_ksize: kernal size 2-D Tuple for pool 最大池化的大小
...
#     input_shape = x_tensor.get_shape().as_list()
#     print(input_shape)
#     print(np.array(input_shape[1:]).prod())
#
...
#     input_shape = x_tensor.get_shape().as_list()
#     已经是2维数组，应该不需要如此麻烦吧
#     flatten_shape = np.array(input_shape[1:]).prod()
#     weights = tf.Variable(tf.truncated_normal([flatten_shape,num_outputs]))
